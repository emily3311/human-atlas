...
export function anatomyZhWithTerms(name: string, sourcedTerms: Readonly<Record<string, { zh: string }>>): string {
  ...
  if (sourcedTerms[core]) return side + sourcedTerms[core].zh;
