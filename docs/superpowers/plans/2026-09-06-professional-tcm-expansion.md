...
- [ ] Write failing tests for complete sequential coverage, GV29 印堂, preserving original39 rich notes, rejecting model quizzes without a placement, and exam list references resolving to real entries.
